...
function Show-UserCredential {
    ...
    Write-Host $PlainTextPassword -ForegroundColor White
...
function Get-LocalUserAccount {
    ...
    try {
        ...
        Write-Log -Message "User '$guid' created successfully."
        ...
        try {
            ...
            Show-UserCredential -Username $fullName -PlainTextPassword $password -GUID $guid
